...
CREATE INDEX IF NOT EXISTS idx_inspirations_book_type ON inspirations(book_id, type, favorited);
CREATE INDEX IF NOT EXISTS idx_inspirations_type_fav ON inspirations(type, favorited);
...
CREATE INDEX IF NOT EXISTS idx_interviews_character ON interview_sessions(character_id, started_at DESC);
